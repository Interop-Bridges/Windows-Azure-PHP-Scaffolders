...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => azure_getconfig('sql_azure_database'),
      'username' => azure_getconfig('sql_azure_username'),
      'password' => azure_getconfig('sql_azure_password'),
      'host' => azure_getconfig('sql_azure_host'),
      'port' => '',
      'driver' => 'sqlsrv',
      'prefix' => azure_getconfig('db_prefix'),
    ),
  ),
);
 ...
 */
if (strcasecmp(azure_getconfig('update_free_access'), 'TRUE') == 0) {
 ...
 *
 */
$drupal_hash_salt = azure_getconfig('drupal_hash_salt');
...
if (strlen(azure_getconfig('base_url')) > 0) {
    $base_url = azure_getconfig('base_url');
}
